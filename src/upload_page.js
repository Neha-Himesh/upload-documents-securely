...
document.querySelector("form").addEventListener("submit", async (e) => {
    ...
    const fileUploaded = fileInputForm.files[0];
    ...
    const typeOfDocumentSelected = typeOfDocumentOptions.options[documentTypeSelect.selectedIndex].text;
    ...
    await addDoc(collection(db, "documents"), {
        ...
        documentType: typeOfDocumentOptions,
        fileName: fileUploaded.name,
        fileType: fileUploaded.size,
